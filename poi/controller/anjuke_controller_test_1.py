# -*- coding: utf-8 -*-
"""
Created on Tue Sep 12 11:29:18 2017
...
def get_anjuke_community_ready_data(city_name):
...
anjuke_old, anjuke_new = get_anjuke_community_ready_data(city_name)

anjuke_old_test, anjuke_new_test = anjuke_old, anjuke_new
anjuke_old_formed, anjuke_new_formed = consolidate_form(anjuke_old_test, anjuke_new_test)

total = merge_community_data(anjuke_old_formed, anjuke_new_formed)




ready_data_file_path = 'E:\\PycharmPrjects\\poi\\controller\\test.tsv'
anjuke_new_test[:100].to_csv(path_or_buf=ready_data_file_path, sep='\t', encoding='utf-8')
