...
formed_anjuke_old, formed_anjuke_new = processor.consolidate_form(anjuke_old, anjuke_new)
total = processor.merge_community_raw_data(formed_anjuke_old, formed_anjuke_new)
...
city_name = '重庆'
anjuke_old, anjuke_new = get_anjuke_community_raw_data()
