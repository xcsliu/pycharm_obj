...
class Anjuke_Processor(object):
    ...
    def get_anjuke_conformed_raw_data(self):
        ...
        consolidated_old, consolidated_new = self.consolidate_second_hand_and_new_community_data_form(anjuke_old,
                                                                                                      anjuke_new)
    ...
    def consolidate_second_hand_and_new_community_data_form(self, second_hand_community_data, new_community_data):
        ...
        second_hand_community_data_with_drop = second_hand_community_data_with_drop.drop_duplicates(
            ['name', 'lat', 'lng'])
...
if __name__ == '__main__':
    ...
    consolidated_old, consolidated_new = processor.consolidate_second_hand_and_new_community_data_form(anjuke_old,
                                                                                                       anjuke_new)
